...
const rulesData = [
  ...
  },
  {
    ...
    content: (
      <ul className="list-none list-inside">
        <li className="flex items-start"><FaCheckCircle className="mr-2 text-blue-500" /> Registration closes on 11th July 2024 (Thursday).</li>
  ...
  },
  {
    ...
    content: (
      <ul className="list-none list-inside">
        <li className="flex items-start"><FaCheckCircle className="mr-2 text-blue-500" /> Ideation phase closes on 13th July 2024 (Saturday) at 11:59pm (IST).</li>
  ...
  },
  {
    ...
    content: (
      <ul className="list-none list-inside">
        <li className="flex items-start"><FaCheckCircle className="mr-2 text-blue-500" /> Registration Deadline: 11th July 2024</li>
        <li className="flex items-start"><FaCheckCircle className="mr-2 text-blue-500" /> Ideation Phase Deadline: 13th July 2024</li>
      </ul>
    ),
  },
  {
