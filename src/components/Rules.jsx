...
const rulesData = [
  ...
  },
  {
    ...
    content: (
      <ul className="list-none list-inside">
        <li className="flex items-start"><FaCheckCircle className="mr-2 text-blue-500" /> Registration closes on 1 st September.</li>
  ...
  },
  {
    ...
    content: (
      <ul className="list-none list-inside">
        <li className="flex items-start"><FaCheckCircle className="mr-2 text-blue-500" /> Ideation phase closes on 5 th September at 00:00am (IST).</li>
  ...
  },
  {
    ...
    content: (
      <ul className="list-none list-inside">
        <li className="flex items-start"><FaCheckCircle className="mr-2 text-blue-500" /> Registration Deadline: 1 st September 2024</li>
        <li className="flex items-start"><FaCheckCircle className="mr-2 text-blue-500" /> Ideation Phase Deadline: 5 th September 2024 00:00am</li>
      </ul>
    ),
  },
  {
